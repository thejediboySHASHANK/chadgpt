        ...
        <div className="grid grid-cols-[3fr_1fr] h-full">
            <div className="border-r-2 border-[#333536] overflow-auto">
                ...
                <div className="flex justify-center">
                    <div
                        className="flex justify-center gap-2 items-end mx-auto border-2 border-[#333536] rounded-xl p-3"
                        style={{position: "absolute", bottom: 40}}
                    >
                        <div className="bg-[#7C8285] rounded-full w-6 h-6">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5}
                        ...
                        <textarea
                            className="bg-chat rounded-xl w-[650px] p-4 text-white mx-auto"
                            placeholder="Type your prompt here"
                            // style={{position: "absolute", bottom : 40}}
                        >
                        </textarea>
                        <div className="bg-logo rounded-xl p-2 w-10 h-10">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5}
                                 stroke="currentColor" className="w-6 h-6 text-white">
                                <path strokeLinecap="round" strokeLinejoin="round"
